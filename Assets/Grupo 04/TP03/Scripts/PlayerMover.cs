...
public class PlayerMover : MonoBehaviour
{
    ...
    private MyStack<Vector2> positionStack = new MyStack<Vector2>();
    ...
    void Update()
    {
        ...
        Debug.Log(positionStack.ToString());
    ...
    int GetIndexFromPosition(Vector2 position)
    {
        ...
        int y = Mathf.RoundToInt(-position.y / cellSize); // generador usa -y
